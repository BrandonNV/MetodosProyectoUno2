            ...
            else
            {
               ...
               //FIN KOLMOGROV
                ...
                for (int a = 0; a < n; a++)
                {
                    ...
                    Console.WriteLine("minus "+dminus[a]);
                    Console.WriteLine("plus "+dplus[a]);
                    Console.WriteLine("max 1 "+maxp);
                    Console.WriteLine("max 2 "+maxm);
                    s = (mu * s + i) % mo;
                ...
                else { label9.Text = "MAX(D+,D-) " + maxm.ToString();
                     max = maxm;
                }
